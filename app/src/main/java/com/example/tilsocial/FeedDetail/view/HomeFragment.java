...
public class HomeFragment extends Fragment implements MainContract.MainView {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        prf = this.getActivity().getSharedPreferences("signindetails", Context.MODE_PRIVATE);
        empid = prf.getString("empidd",null);
...
//            ft.add(R.id.your_placeholder, signinfragment);
//            ft.commit();
